...
%     patch([time(ch_pos(2)), time(ch_pos(2)), time(ch_pos(3)), time(ch_pos(3)), time(ch_pos(2))], ...
%         [yl(1), yl(2), yl(2), yl(1), yl(1)],...
%         'black', 'FaceColor', 'green', 'FaceAlpha', 0.3);
%     patch([time(ch_pos(3)), time(ch_pos(3)), time(ch_pos(4)), time(ch_pos(4)), time(ch_pos(3))], ...
%         [yl(1), yl(2), yl(2), yl(1), yl(1)],...
%         'black', 'FaceColor', 'green', 'FaceAlpha', 0.4);
%     patch([time(ch_pos(4)), time(ch_pos(4)), xl(2), xl(2), time(ch_pos(4))], ...
%         [yl(1), yl(2), yl(2), yl(1), yl(1)],...
%         'black', 'FaceColor', 'green', 'FaceAlpha', 0.5);
end
